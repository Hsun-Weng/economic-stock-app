...
public class TaiwanStockIndexServiceImpl implements TaiwanStockIndexService {
    ...
    public List<Map<String, Object>> getBatchLatestPriceList(List<String> indexCodeList) {
        ...
        for(String stockCode : indexCodeList){
            ...
            List<TaiwanStockIndex> priceList = mongoTemplate.find(query, TaiwanStockIndex.class);
    ...
    private Map<String, Object> convertStockIndexListToMap(List<TaiwanStockIndex> priceList) {
        Map<String, Object> priceMap = new HashMap<String, Object>();
        TaiwanStockIndex latestPrice = priceList.get(0);
        TaiwanStockIndex previousPrice = null;
