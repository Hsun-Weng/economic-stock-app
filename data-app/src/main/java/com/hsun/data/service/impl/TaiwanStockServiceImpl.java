...
public class TaiwanStockServiceImpl implements TaiwanStockService {
    ...
    public List<Map<String, Object>> getBatchLatestPriceList(List<String> stockCodeList) {
        ...
        for(String stockCode : stockCodeList){
            ...
            List<TaiwanStock> priceList = mongoTemplate.find(query, TaiwanStock.class);
    ...
    private Map<String, Object> convertStockListToMap(List<TaiwanStock> priceList) {
        Map<String, Object> priceMap = new HashMap<String, Object>();
        TaiwanStock latestPrice = priceList.get(0);
        TaiwanStock previousPrice = null;
